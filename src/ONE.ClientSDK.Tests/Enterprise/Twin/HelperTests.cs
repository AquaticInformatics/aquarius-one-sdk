...
namespace ONE.ClientSDK.Tests.Enterprise.Twin;
...
public class HelperTests
{
	...
	{
		var result = DigitalTwinHelper.GetTwinDataProperty(null, TestPath, TestProperty);
	...
	public void GetTwinDataProperty_TwinDataIsNull_ReturnsEmpty()
	{
		...
		var result = DigitalTwinHelper.GetTwinDataProperty(digitalTwin, TestPath, TestProperty);
	...
	public void GetTwinDataProperty_TwinDataIsInvalidJson_Throws()
	{
		...
		var testAction = () => DigitalTwinHelper.GetTwinDataProperty(digitalTwin, TestPath, TestProperty);
	...
	public void GetTwinDataProperty_GivenInvalidPath_ReturnsEmpty()
	{
		...
		var result = DigitalTwinHelper.GetTwinDataProperty(digitalTwin, "invalidPath", TestProperty);
	...
	public void GetTwinDataProperty_GivenInvalidPropertyName_ReturnsEmpty()
	{
		...
		var result = DigitalTwinHelper.GetTwinDataProperty(digitalTwin, TestPath, "invalidProperty");
