...
namespace ONE.Operations
{
    public class CloneOperation
    {
        ...
        public async Task<bool> CloneAsync(ClientSDK clientSDK, DigitalTwin destinationTenantTwin)
        {
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Creating Operation Twin" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Creating Spreadsheet" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Loading Source Locations" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Loading Column Twins" });
            var sourceColumnDigitalTwins = _operationCache.ColumnTwins;


            // Task 3.1 Worksheet 15 Min
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying 15 Min Worksheet" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying Hourly Worksheet" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying 4 Hour Worksheet" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying Daily Worksheet" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Updating 15 Min Worksheet Computations" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Updating Hourly Worksheet Computations" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Updating 4 Hour Worksheet Computations" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Updating Daily Worksheet Computations" });
            ...
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Worksheet Sheets (Views)" });
        ...
        private async Task<bool> CopySheetsAsync(string destinationOperationId)
        {
            ...
            foreach (var sourceConfiguration in sourceSheets)
            {
                ...
                Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying {sourceWorksheetViewConfiguration.worksheetType} Sheet: {sourceWorksheetViewConfiguration.name}" });
        ...
        private async Task<Dictionary<string, string>> CopyLocationsAsync(Dictionary<string, string> sourceToDestinationTwinMapping, string destinationParentId, string sourceParentId, List<DigitalTwin> sourceDigitalTwins)
        {
            ...
            {
                Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying Location Twin {sourceTwin.Name}" });
        ...
        {
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying {sourceColumn.Name}" });
        ...
        private async Task<bool> CopyWorksheetAsync(WorksheetDefinition sourceWorksheetDefinition, Dictionary<string, string> sourceToDestinationLocationTwinMapping, List<DigitalTwin> columnTwins, string sourceOperationId, string destinationOperationId, EnumWorksheet worksheetType)
        {
            ...
            foreach (var sourceColumn in sourceWorksheetDefinition.Columns)
            {
                ...
                if (x % 100 == 0)
                {
                    ...
                    {
                        Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Failed to save worksheet definition" });
                        return false;
                    }
                    else
                    {
        ...
        public async Task<Dictionary<uint, uint>> GetSourceToDestinationColumnMap(string operationId)
        {
            ...
            var columnTwins = await _clientSDK.DigitalTwin.GetDescendantsByTypeAsync(operationId, Enterprise.Twin.Constants.TelemetryCategory.ColumnType.RefId);
        ...
        private async Task<bool> CopyWorksheetComputationsAsync(WorksheetDefinition sourceWorksheetDefinition, string sourceOperationId, string destinationOperationId)
        {
            ...
            for (int x = 0; x < sourceWorksheetDefinition.Columns.Count; x++)
            {
                ...
                {
                    Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Copying Formula {sourceWorksheetDefinition.EnumWorksheet} Column: {sourceColumn.Name}" });
        ...
        {
            Event(null, new ClientApiLoggerEventArgs { EventLevel = EnumEventLevel.Trace, Module = "OperationExport", Message = $"Updating Destination Column Twin {destinationColumn.ColumnId}" });
